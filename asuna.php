	...
	<pre>$hasil</pre>
		<form method='POST'>
			<div class='input-group mb-3'>
				...
				<div style='border: 1px #000000 solid; padding: 10px;background-color:#FFFFFF; text-align: left;height:100%; margin-top:10px;'>
